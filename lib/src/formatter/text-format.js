...
var translator_context_1 = require("../lang/translator-context");
...
var TextFormat = function (_a) {
    ...
    if (type === 'date') {
        return React.createElement("span", null, locale ? dayjs(value).locale(locale).format(format) : dayjs(value).format(format));
    }
    else if (type === 'number') {
